...
export const DEFAULT_SHORTCUTS: Record<string, Shortcut> = {
	...
	cyclePrev: { id: 'cyclePrev', label: 'Previous Project', keys: ['Meta', '['] },
	cycleNext: { id: 'cycleNext', label: 'Next Project', keys: ['Meta', ']'] },
	navBack: { id: 'navBack', label: 'Navigate Back', keys: ['Meta', 'Shift', ','] },
	navForward: { id: 'navForward', label: 'Navigate Forward', keys: ['Meta', 'Shift', '.'] },
	newInstance: { id: 'newInstance', label: 'New Project', keys: ['Meta', 'n'] },
	...
	clearContext: { id: 'clearContext', label: 'Clear Context', keys: ['Meta', 'k'] },
	quickAction: { id: 'quickAction', label: 'Quick Actions', keys: ['Meta', 'Shift', 'p'] },
